...
describe 'JobOffersController' do
  ...
  describe 'post :create' do
    it 'should call TwitterClient when create_and_twit is present' do
      ...
      post '/job_offers/create', { job_offer_form: { title: 'Programmer offer', expired_date: Date.today }, create_and_twit: 'create_and_twit' }, signed_in_session
    ...
    it 'should not call TwitterClient when create_and_twit not present' do
      ...
      post '/job_offers/create', { job_offer_form: { title: 'Programmer offer', expired_date: Date.today } }, signed_in_session
      expect(last_response.location).to eq('http://example.org/job_offers/my')
    end
  end
end
